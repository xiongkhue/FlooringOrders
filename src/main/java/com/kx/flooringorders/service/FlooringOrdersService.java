...
public interface FlooringOrdersService {
     ...
     */
    Order addOrder(BigDecimal number, Order order)
     ...
     */
    Order getOrder(BigDecimal number)
            throws FlooringOrdersDaoException;
     ...
     */
    Order editOrder(BigDecimal number, Order order)
            throws FlooringOrdersDaoException;
     ...
     */
    Order removeOrder(BigDecimal number)
            throws FlooringOrdersDaoException;
    ...
    HashMap<BigDecimal, Order> returnOrders();
